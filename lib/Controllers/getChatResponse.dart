...
//! No se pudo implementar el asistente debido a que tendriamos que refactorizar todo el proyecto, pero esta solucion es la mas parecida a un asistente.
 final request = ChatCompleteText(
  ...
  messages: [
    {
      "role": "system",
      "content": "Tu principal objetivo es servir como el asistente óptimo para ayudar a los usuarios a manejar el estrés. Tus respuestas deben ser claras, cortas y concisas."
    },
